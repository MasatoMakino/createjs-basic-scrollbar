...
var ScrollBarView = /** @class */ (function (_super) {
    ...
    ScrollBarView.prototype.changeRateToPixel = function (rate) {
        ...
        var currentPix = ((currentMax - currentMin) * rate) / SliderView_1.SliderView.MAX_RATE + currentMin;
    ...
    ScrollBarView.prototype.changePixelToRate = function (pixel) {
        ...
        var currentMax = this._maxPosition - buttonSize / 2;
        var currentMin = this._minPosition + buttonSize / 2;
        var currentRate = ((pixel - currentMin) / (currentMax - currentMin)) * SliderView_1.SliderView.MAX_RATE;
    ...
    ScrollBarView.prototype.initSliderButtonSize = function () {
        ...
        if (this.hasEventListener(SliderEvent_1.SliderEventType.CHANGE))
            return;
        this.addEventListener(SliderEvent_1.SliderEventType.CHANGE, this.updateContentsPosition);
    };
    ...
    ScrollBarView.prototype.onDisposeFunction = function (e) {
        this.removeEventListener(SliderEvent_1.SliderEventType.CHANGE, this.updateContentsPosition);
