...
var SliderView = /** @class */ (function (_super) {
    ...
    function SliderView(option) {
        ...
        _this.moveSlider = function (e) {
            ...
            _this.dispatchEvent(new SliderEvent_1.SliderEvent(SliderEvent_1.SliderEventType.CHANGE, _this.rate));
        };
        /**
         * スライダーのドラッグ終了時の処理
         * @param	e
        ...
        _this.moveSliderFinish = function (e) {
            ...
            _this.dispatchEvent(new SliderEvent_1.SliderEvent(SliderEvent_1.SliderEventType.CHANGE_FINISH, _this.rate));
        };
        /**
         * このインスタンスを破棄する。
         * @param	e
    ...
    SliderView.prototype.changeRate = function (rate) {
        ...
        this.dispatchEvent(new SliderEvent_1.SliderEvent(SliderEvent_1.SliderEventType.CHANGE, this.rate));
    };
    /**
     * スライダーボタンの位置を制限する関数
    ...
    SliderView.prototype.onPressBase = function (evt) {
        ...
        this.moveSlider(evt);
        this.dispatchEvent(new SliderEvent_1.SliderEvent(SliderEvent_1.SliderEventType.CHANGE_FINISH, this.rate));
    };
    /**
    ...
    SliderView.prototype.changeRateToPixel = function (rate) {
        var pix = ((this._maxPosition - this._minPosition) * rate) / SliderView.MAX_RATE +
            this._minPosition;
